    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/stock/**").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.POST, "/stock/addProduct/**").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.POST, "/stock/removeProduct/**").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/stock/**").hasAuthority("ROLE_ADMIN")
